...
htmlhelp_basename = 'Corpusreactordoc'
...
latex_documents = [
  ('index', 'Corpusreactor.tex', u'corpus.reactor Documentation',
...
man_pages = [
    ('index', 'corpusreactor', u'corpus.reactor Documentation',
